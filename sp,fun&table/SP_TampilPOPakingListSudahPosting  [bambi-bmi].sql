...
GO
CREATE PROCEDURE [dbo].[SP_TampilPOPakingListSudahPosting]
@status VARCHAR(1),
@tahun  int,
@userid VARCHAR(100)
...
BEGIN
	...
	IF(@status ='Y')
		BEGIN
			...
			Pib,Forwarder,Total,UserPosting,DatePosting
	...
	SELECT 	No_Pls,No_Pli,NoPo,POTransacid,EntryDate,Note,supid,userid,Totaldetail,Pib,Forwarder,Total,UserPosting,DatePosting FROM #temptess ORDER BY No_Pls ASC
END


GO
EXEC SP_TampilPOPakingListSudahPosting 'Y','2024','herman'
