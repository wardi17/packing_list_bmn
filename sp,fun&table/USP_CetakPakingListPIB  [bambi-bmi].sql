USE [bambi-bmi]
GO
/****** Object:  StoredProcedure [dbo].[USP_CetakPakingListPIB]    Script Date: 05/24/2024 08:10:53 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROCEDURE [dbo].[USP_CetakPakingListPIB]
...
BEGIN
	...
	BEGIN
	 ...
	 SELECT  a.ItemNo,a.Partid,a.PartName,c.Total as biaya_pib,b.Komposisi,b.Qty, COALESCE(b.pib, 0),
...
GO
EXEC USP_CetakPakingListPIB'BMI_PL250508163625','PO210603091924'
