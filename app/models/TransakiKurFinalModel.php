...
{
    private $tablehead = "[bmnpt].[dbo].POPAKINGLIST_KURS_Temporary";
    private $table_fro = "[bmnpt].[dbo].FrowaderDetail_Temporary";
    private $table_dtl = "[bmnpt].[dbo].POPAKINGLIST_KURSDETAIL_Temporary";
